...
namespace Department.SafeBox
{
    public partial class frmShowSafeBox : Form
    {
        ...
        private async void frmShowSafeBox_Load(object sender, EventArgs e) => await LoadDataAsync(ST);
        ...
        private async void mnuDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ST)
                {
                    ...
                    prd.Status = false;
                    var res = await SafeBoxBussines.ChangeStatusAsync(prd);
                    if (res.HasError)
                    {
