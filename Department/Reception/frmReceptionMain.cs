...
namespace Department.Reception
{
    public partial class frmReceptionMain : MetroForm
    {
        ...
        public frmReceptionMain(Guid guid)
        {
            InitializeComponent();
        ...
        private void btnSearchOwner_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cls.Receptor = frm.Customer.Guid;
        ...
        private async void btnFinish_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var pe = await CustomerBussines.GetAsync(cls.Receptor);
                if (pe != null)
                {
                    pe.Account += fPrice;
                ...
                var desc = $"دریافت مبلغ {lblTotalPrice.Text} ریال در تاریخ {lblDateNow.Text} {txtDesc.Text}";
                if (log == null)
                {
