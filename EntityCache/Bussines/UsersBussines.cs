...
namespace EntityCache.Bussines
{
    public class UsersBussines : IUsers
    {
        ...
        public static async Task<UsersBussines> GetAsync(Guid guid) => await UnitOfWork.Users.GetAsync(guid);

        public static async Task<List<UsersBussines>> GetAllAsync() => await UnitOfWork.Users.GetAllAsync();

        public static List<UsersBussines> GetAll() => AsyncContext.Run(GetAllAsync);
        ...
        public static async Task<List<UsersBussines>> GetAllAsync(string search)
        {
            try
            {
